...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Device',
            fields=[
                ('entity_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='monitoring.entity')),
            ],
            bases=('monitoring.entity',),
        ),
        migrations.CreateModel(
            name='Location',
            fields=[
        ...
        migrations.AddField(
            model_name='device',
            name='host',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitoring.host'),
        ),
    ]
